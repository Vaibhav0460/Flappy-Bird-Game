...
# Global Variables for the random.game
FPS = 32
SCREENWIDTH = 289
SCREENHEIGHT = 511
...
def welcomeScreen():
    ...
    while True:
        for event in pygame.event.get():
            ...
            # if the user presses space key or up key, start the game for them
...
def mainGame():
    ...
    while True:
        ...
        # Add a new pipe when the first pipe is about ot go to cross the leftmost part of the screen
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by Avenger')
